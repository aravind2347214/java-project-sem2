...
public class View extends JFrame {
	...
	public View() {
		...
		lblId.setBounds(500, 135, 125, 28);
		contentPane.add(lblId);

		textField = new JTextField();
		textField.setBounds(600, 127, 188, 39);
		...
		lblPassword.setBounds(500, 200, 125, 28);
		...
		lblNewLabel_2.setBounds(500, 464, 178, 23);
				...
				if (textField.getText().equals("m_001")) {
					...
					if (result == false) {
						...
						if (result1 == true) {
							...
							// System.out.println("Login customer id go to form1 customer id: "+
							// customerId);
						} else {
							lblNewLabel_2.setText("Login failed");
						}
		...
		// btnLogi//Image image4 = new
		// ImageIcon(this.getClass().getResource("/Ok-icon.png")).getImage();
		// btnLogin.setIcon(new ImageIcon(image4));
		btnLogin.setFont(new Font("Calibri", Font.BOLD, 16));
		btnLogin.setBounds(715, 250, 70, 30);
		...
		btnCreateAccount.setBackground(new Color(240, 230, 140));
		btnCreateAccount.setForeground(Color.BLACK);
		btnCreateAccount.setFont(new Font("Calibri", Font.BOLD, 16));
		btnCreateAccount.setBounds(600, 290, 185, 30);
		contentPane.add(btnCreateAccount);

		passwordField = new JPasswordField();
		passwordField.setBounds(600, 192, 188, 39);
		...
		JLabel lblNewLabel_3 = new JLabel("J .A. M  Cafe Login");
		lblNewLabel_3.setFont(new Font("Calibre", Font.BOLD, 60));
		lblNewLabel_3.setForeground(Color.BLACK);
		lblNewLabel_3.setBounds(400, 11, 600, 75);
